...
const experiences_route_1 = __importDefault(
  require("./routes/experiences.route")
);
const submissions_route_1 = __importDefault(
  require("./routes/submissions.route")
);
const image_route_1 = __importDefault(require("./routes/image.route"));
// admin
const contactInfo_route_1 = __importDefault(
  require("./routes/contactInfo.route")
);
const suggestions_routes_1 = __importDefault(
